...
using PowerRunner.Actions;

namespace PowerRunner
{
    internal class Extend : IExtendDailyActivityViewActions, IExtendActivityReportsViewActions, IExtendSettingsPages
    {
        ...
        public IList<ISettingsPage> SettingsPages
        {
            get
            {
                List<ISettingsPage> list = new List<ISettingsPage> { new Settings.SettingsPage() };
                return list;
            }
        }
